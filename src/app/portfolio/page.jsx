      ...
      <div className="h-[500vh] relative" ref={ref}>
        ...
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
          <motion.div style={{ x }} className="flex ">
            <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-r from-purple-300 to-red-50" />
            ...
            <div className="w-screen h-screen flex flex-row gap-16 items-center justify-center text-center">
